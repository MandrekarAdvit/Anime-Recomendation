      ...
      <div className="w-full max-w-md bg-gray-950 p-12 rounded-[3rem] border border-emerald-900/30 shadow-[0_0_80px_rgba(16,185,129,0.05)] relative overflow-hidden">
        ...
        <div className="relative z-10">
          <header className="text-center mb-10">
            ...
            <h1 className="text-4xl font-black text-white mt-4 uppercase italic">Create Account</h1>
            <p className="text-emerald-500/60 font-bold text-xs tracking-[0.3em] uppercase mt-2">Start your collection</p>
          </header>
          ...
          <p className="text-center mt-8 text-gray-500 font-semibold">
            Already a member? 
            <Link to="/login" className="text-emerald-400 hover:text-emerald-300 ml-2 transition-colors underline decoration-emerald-900/50">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
